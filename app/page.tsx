...
import logo from './images/favicon.ico'; // Importing the image
...
export default function Page() {
  ...
  return (
    <main className="min-h-screen flex items-center justify-center">
      <div className="p-6 bg-white shadow-md rounded-md w-full sm:w-[90%] md:w-[90%] max-w-90%">
        <h1 className="text-2xl font-bold mb-4 text-center flex items-center justify-center">
          {/* Use the image only after the component has mounted */}
          <img
            src={logo.src}
            alt="Logo"
